...
void TIM_DeInit(TIM_TypeDef* TIMx);															  //将外设TIMx寄存器重设为缺省值 TIM1-TIM17
void TIM_TimeBaseInit(TIM_TypeDef* TIMx, TIM_TimeBaseInitTypeDef* TIM_TimeBaseInitStruct);	  //初始化定时器结构体的时间基数单位
